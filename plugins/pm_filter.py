...
async def filter(client, message):
    ...
    if 2 < len(message.text) < 100:    
        ...
        if len(btn) > 10: 
            ...
            if poster:
                await message.reply_photo(photo=poster, caption=f"**🎬 Title: {search}\n**🌟 Rating:** {random.choice(RATING)}\n**🎭 Genre:** {random.choice(GENRES)}\n**🗳️ Votes:** {random.choice(VOTES)}\n\n**🗣 Requested By:** {message.from_user.mention}**♻️ {message.chat.title}**", reply_markup=InlineKeyboardMarkup(buttons))

            else:
                await message.reply_text(f"**🎬 Title: {search}\n**🌟 Rating:** {random.choice(RATING)}\n**🎭 Genre:** {random.choice(GENRES)}\n**🗳️ Votes:** {random.choice(VOTES)}\n\n🗣️ Requested By:** {message.from_user.mention}**♻️ {message.chat.title}**", reply_markup=InlineKeyboardMarkup(buttons))
            return
        ...
        if poster:
            ...
            await message.reply_text(f"**🎬 Title: **{search}**\n🌟 Rating:** {random.choice(RATING)}\n**🎭 Genre:** {random.choice(GENRES)}\n**🗳️ Votes:** {random.choice(VOTES)}\n\n**🗣 Requested By:** {message.from_user.mention}**★ {message.chat.title} ♻️**", reply_markup=InlineKeyboardMarkup(buttons))
...
async def group(client, message):
    ...
    if 2 < len(message.text) < 50:    
        ...
        search = message.text
        result_txt = f"**🎬 Title: **{search}**\n🌟 Rating:** {random.choice(RATING)}\n**🎭 Genre:** {random.choice(GENRES)}\n**🗳️ Votes:** {random.choice(VOTES)}\n\n**🗣 Requested By:** {message.from_user.mention}**★ {message.chat.title} ♻️**"
